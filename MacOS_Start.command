...
# MacOS_Start.command
# ---------------------------------------------------------------------------
#  Self-contained macOS/Linux launcher for the StudioLink Lite bridge.
...
BRIDGE_PORT="${SLL_BRIDGE_PORT:-${ZS_BRIDGE_PORT:-17613}}"
LOG_DIR="logs"
...
echo "  ##   StudioLink Lite stops if you close it. Just          ##"
