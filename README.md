...
Replace your `studiolink-lite-extension` folder with the latest copy, reload StudioLink Lite on your browser's extensions page, and reload the AI chat tab. The extension should show version **2.0.2**. Start a new chat and click **Start Roblox agent**.

Version 2.0.2 fixes WorkBuddy/Hy4 message insertion and send detection. Replace the previous extension folder with this release and reload the browser extension before starting a new Roblox agent session.
