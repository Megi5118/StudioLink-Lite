...
const ZSProvider = (() => {
  ...
  // Scope to the site's composer only; skip StudioLink Lite's own injected textarea
  ...
  function truncateForSend(text) {
    ...
    const marker =
      `\n\n[…StudioLink Lite: result truncated to fit Qwen's ${SEND_CAP}-character input ` +
  ...
  // tool-calls instead of StudioLink Lite commands. Removed 2026-07: the real cause of
