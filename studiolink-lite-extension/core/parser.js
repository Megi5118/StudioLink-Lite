...
// core/parser.js - StudioLink Lite command parsing. PURE string logic, zero DOM:
...
const ZSParse = (() => {
  ...
  // instead of a StudioLink Lite command - seen live in user reports, DeepSeek only:
  //   <|DSML|>tool_calls>
  ...
  // new StudioLink Lite schema ("command"/"params") and the legacy/function-calling
  ...
  // The assistant emitted a StudioLink Lite command (JSON or a ###LUA### block), or a
