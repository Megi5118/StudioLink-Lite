...
// DeepSeek sometimes answers in its own agentic markup instead of a StudioLink Lite
...
const dsmlFull = [
  ...
  '<|DSML|>parameter name="target_file" string="true">game.ServerStorage.StudioLinkLite.Memory</|DSML|>parameter>',
  '</|DSML|>invoke>',
  '</|DSML|>tool_calls>',
].join("\n");
...
// DSML is NOT a StudioLink Lite command shape: it must reach the fallthrough guards.
